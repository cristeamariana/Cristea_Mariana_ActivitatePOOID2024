...
public:
	...
	Masina(string _marca, int nrComponente, float* preturi) :id(++nrMasini) {
		...
		//shallow copy = nu este ok, trebuie folosit deep copy
		//this->preturi = preturi;

		//deep copy = este varianta corecta
	...
	//masina3 += 1000; exemplificare operatorul plus egal 
	...
	//masina2 = 3000.0f + masina3; operatorul egal cand avem primul de tip float si al doilea de tip obiect
	...
	void setNrComponente(int nrComponente) {
		if (nrComponente > 0) {
			...
			//throw "Valoare negativa!"; evitarea blocarii printr-un mesaj de exceptie
			//throw 400; evitarea blocarii printr-un cod de exceptie
			throw new exception();
		}
	}
...
int main() {
	...
	//masina3 = masina1;//masina3.operator=(masina1); exemplificare operatorul egal prin 2 tipuri de scriere echivalenta
	//masina2 = masina3 = masina1; ordinea in care se proceseaza este de la dreapta spre stanga 
